...
#ident "@(#) LiS version.c 2.19 10/12/04 16:25:34 "


char	lis_version[] = "2.19.4" ;
char	lis_date[]    = "26 August 15" ;
...
2.19    Incorporated Paul Landry`s 64 bit/PPC/S390 code changes
	...
	Incorporated Paul Landry`s SLES 10 support.
	Incorporated RHEL 5 support.
	Kernel 3.x support
