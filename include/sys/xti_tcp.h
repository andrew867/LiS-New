/*****************************************************************************
 ...
 @(#) $RCSfile: xti_tcp.h,v $ $Name: LiS-2-19-0 $($Revision: 1.1.1.1 $) $Date: 2005/04/12 20:27:06 $
...
#ident "@(#) $RCSfile: xti_tcp.h,v $ $Name: LiS-2-19-0 $($Revision: 1.1.1.1 $) Copyright (c) 1997-2004 OpenSS7 Corporation."
