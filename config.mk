...
# Added -D"KBUILD_BASENAME=" and autoconf.h to keep SLES10/RHEL5 (kernels >2.6.15) happy
ifdef KINCL_AUTOCONF
    XOPTS += -ffreestanding 
    XOPTS += -D"KBUILD_BASENAME=" 
    XOPTS += -imacros $(KINCL_AUTOCONF)
    XOPTS += -D"DEBUG_HASH=0" -D"DEBUG_HASH2=42" -D"KBUILD_STR(s)=\#s" -D"KBUILD_MODNAME=KBUILD_STR()" -mtune=generic 
    #XOPTS += -D"DEBUG_HASH=0" -D"DEBUG_HASH2=42" -mtune=generic 
endif
#XOPTS+= $(KBUILD_STR)
...
#
ifeq ($(LIS_TARG),linux)
XOPTS += -I$(KINCL) -I$(KINCL_X86_GENERIC) $(KINCL_MACH_GENERIC) $(KINCL_MACH_DEFAULT) -I$(KINCL_GENERATED)
ifeq ($(RH_71_KLUDGE),y)
XOPTS += -DRH_71_KLUDGE
endif
ifeq ($(SIGMASKLOCK),y)
