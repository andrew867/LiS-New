#!/usr/bin/perl -an
# $Id: nodeconfig.pl,v 1.1.1.1 2005/04/12 20:27:03 ragnar Exp $
#
...
#
# $Log: nodeconfig.pl,v $
# Revision 1.1.1.1  2005/04/12 20:27:03  ragnar
#
#
...
BEGIN { 
	...
	print "# Auto-built from\n#\t$src\n# by $0\n", 
		'# $Header: /u/x/cvsroot/LiS/nodeconfig.pl,v 1.1.1.1 2005/04/12 20:27:03 ragnar Exp $', "\n", <<"EOF";
